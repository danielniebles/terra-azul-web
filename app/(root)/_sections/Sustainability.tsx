  ...
  return (
    <section className="bg-terra-sand">
      <div className="container double-grid">
        <article className="flex flex-col p-4 mt-12 md:my-0 md:p-12 justify-center">
        ...
        <article className="flex flex-col py-0 md:py-12 ">
          ...
          <div className="grid grid-cols-2 p-4 md:p-0 md:grid-cols-4 gap-2">
